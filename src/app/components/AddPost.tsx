...
const AddPost=  () =>{
    ...
    return(
        ...
        <textarea placeholder="What's on your mind?.... " className=" flex-1 bg-slate-100 rounded-lg p-2" name="desc"
        ...
        <AddPostButton/>
             ...
             <div className="flex items-center gap-4 mt-4 text-gray-400 flex-wrap ">
                            ...
                            <CldUploadWidget uploadPreset="connectify" onSuccess={(result, {widget}) => {setImg(result.info); widget.close()}} >
                {({ open }) => {
                    return (
